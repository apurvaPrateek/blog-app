...
createNotesBtn.addEventListener("click", () => {
  ...
  newNote.innerHTML = `
    ...
    <div><textarea class="note-content" placeholder="start writing here..."></textarea>
  ...
  if (savedData) {
    savedData.forEach((note) => {
      ...
      newNote.innerHTML = `
        ...
        <div><textarea class="note-content" placeholder="start writing here...">${note.content}</textarea>
        <img src="./images/delete.png" alt="" class="delete-notes"></div>
      `;
      newNote.classList.add("input-notes");
      contentSection.appendChild(newNote);
